#!/bin/sh -eux
NIX_ASSET=https://cdn.glitch.me/5a9fc653-d4ea-4f87-b41f-2015392bbd4a/nix-202407b.tar.gz?v=1721346571059
NIX=/tmp/nix/store/xadyyfl4an8hbjdkaznx2bl84a8hj7iw-nix-2.18.5
