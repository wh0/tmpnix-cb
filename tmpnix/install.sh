#!/bin/sh -eux
NIX_ASSET=https://cdn.glitch.me/5a9fc653-d4ea-4f87-b41f-2015392bbd4a/nix-202408c.tar.gz?v=1724605808384
NIX=/tmp/nix/store/n58rviv7aqv1c61dxd6nwaadmsmy6nsv-nix-2.18.5
