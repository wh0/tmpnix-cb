#!/bin/sh -eux
NIX_ASSET=https://cdn.glitch.me/5a9fc653-d4ea-4f87-b41f-2015392bbd4a/nix-202409b.tar.gz?v=1727412487790
NIX=/tmp/nix/store/cxx11b1lyvf8kww7wiraiwzrsm442xck-nix-2.18.7
